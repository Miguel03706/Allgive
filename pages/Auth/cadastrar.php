    ...
    <div class="main">
        <div class="container-fluid header">
            <div class="row align-items-center topo">
                <aside class="col-md-6 text-center" onClick="exibir()">Doador</aside>
                <aside class="col-md-6 text-center" onClick="ocultar()">ONG</aside>
            </div>
        </div>

        <div class="form-donate" name="form_donate"> 
